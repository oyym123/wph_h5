...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        defaultFileActionSettings = {
            ...
            indicatorError: '<i class="glyphicon1 glyphicon-exclamation-sign1 text-danger"></i>',
    ...
    FileInput.prototype = {
        ...
        previewDefault: function (file, previewId, isDisabled) {
            ...
            if (isDisabled === true) {
                ...
                footer += '<div class="file-other-error text-danger"><i class="glyphicon1 glyphicon-exclamation-sign1"></i></div>';
            }
    ...
    $.fn.fileinput.defaults = {
        ...
        msgValidationErrorIcon: '<i class="glyphicon1 glyphicon-exclamation-sign1"></i> ',
        msgErrorClass: 'file-error-message1',
